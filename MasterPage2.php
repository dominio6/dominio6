...
<body  onload="pag();mueveReloj();verasp(); pageLoad();">
     ...
     <div class='rounduser' align='left'>
         ...
         <div class='contenidob'>
          <table   summary='1' border='0'width='100%'>
             <tr>
               <td background='img/marco.png' width='200' height='50' align='center'><a class='screenshot' ><img src='img/logoD6.png' width='100%' alt='' /></a></td>
                <td >
