...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "Por favor, introduzca el mismo valor que otra vez.",
		accept: "Por favor, introduzca un valor con una extensión válida.",
		maxlength: $.format("Por favor, introduzca no más de {0} caracteres."),

		minlength: $.format("Por favor, introduzca al menos {0} caracteres."),
		minlength: $.format("+{0}"),

		rangelength: $.format("Por favor, introduzca un valor entre {0} y {1} caracteres de largo."),
